...
public class FashionFragment extends BaseFragment {
    private TextView smallTitle, title, subTitle, noBoxSmallTitle, noBoxTitle, noBoxNubTitle, noBoxVerticalTitle, noBoxColorTitle, threeSmallTitle, threeTitle, threeSubTitle;
